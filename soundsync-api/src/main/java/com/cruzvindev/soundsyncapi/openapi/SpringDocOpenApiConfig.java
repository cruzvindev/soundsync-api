...
public class SpringDocOpenApiConfig {
	...
	public OpenAPI soundsyncDoc() {
		return new OpenAPI()
				...
				.tags(Arrays.asList(
						...
						new Tag().name("Artistas").description("Gerencia os artistas"),
						new Tag().name("Músicas").description("Gerencia as músicas")
	...
	private Map<String, Schema> gerarSchemas() {
		...
		Map<String, Schema> problemSchema = ModelConverters.getInstance().read(ProblemTypeOpenApi.class);
		Map<String, Schema> problemObjectSchema = ModelConverters.getInstance().read(ProblemTypeOpenApi.Object.class);
	...
	private Map<String, ApiResponse> gerarResponses() {
		...
		Content content = new Content()
				.addMediaType(APPLICATION_JSON_VALUE,
						new MediaType().schema(new Schema<ProblemTypeOpenApi>().$ref("Problema")));
